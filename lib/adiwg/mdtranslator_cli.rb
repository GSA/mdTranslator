...
class MdtranslatorCLI < Thor
   ...
   desc 'translate [FILE]', 'Pass JSON string or filename plus parameters to mdtranslator translate'
   long_desc <<~LONGDESC
   ...
   desc 'version', 'Returns the version of mdTranslator'
   long_desc <<-LONGDESC
