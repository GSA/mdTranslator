      ...
      module Iso191151datagov
        module Responsibility
          ...
          def self.unpack(xRParty, hResponseObj)
            ...
            if xRole.nil?
              msg = "WARNING: ISO19115-1 reader: element \'#{@@roleXPath}\' "\
              ...
              if xRC.nil? && !AdiwgUtils.valid_nil_reason(xRole, hResponseObj)
                msg = "WARNING: ISO19115-1 reader: element \'#{xRole.name}\' "\
            ...
            unless contactName.nil?
              ...
              contactId = Iso191151datagov.add_contact(contactName, hContact[:isOrganization])
            ...
            Iso191151datagov.set_contact(hContact)
