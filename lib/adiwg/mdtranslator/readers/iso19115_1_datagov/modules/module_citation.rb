      ...
      module Iso191151datagov
        module Citation
          ...
          def self.unpack(xCitationParent, hResponseObj)
            ...
            if xTitle.nil?
              msg = "WARNING: ISO19115-1 reader: element \'#{@@titleXPath}\' "\
              ...
              if xStr.nil? && !AdiwgUtils.valid_nil_reason(xTitle, hResponseObj)
                msg = "WARNING: ISO19115-1 reader: element \'#{xTitle.name}\' "\
            ...
            if xDates.empty?
              msg = "WARNING: ISO19115-1 reader: element \'#{@@dateXPath}\' "\
                "is missing in \'#{xCitation.name}\'"
              hResponseObj[:readerValidationMessages] << msg
              hResponseObj[:readerValidationPass] = false
            else
            ...
            # responsible parties are grouped by role (see class_citation:121 in ISO19115-1 writer)
