...
require 'adiwg/mdtranslator/readers/iso19115_2/modules/module_transfer'
require_relative 'iso19115_2_test_parent'

class TestReaderIso191152Transfer < TestReaderIso191152Parent
   @@xDoc = TestReaderIso191152Parent.get_xml('iso19115-2_transferOptions.xml')
   @@nameSpace = ADIWG::Mdtranslator::Readers::Iso191152::Transfer
