...
# parent class for all iso19115-2 tests
...
class TestReaderIso191152Parent < Minitest::Test
   @@hResponseObj = {
   ...
   def self.set_xdoc(xDoc)
      ADIWG::Mdtranslator::Readers::Iso191152::Iso191152.set_xdoc(xDoc)
   end
   ...
   def self.set_int_obj(intObj = nil)
      ...
      ADIWG::Mdtranslator::Readers::Iso191152::Iso191152.set_int_obj(intObj)
      intObj
   end

   # get intObj for assertions of data written to other intObj sections during test
   def self.get_int_obj
      ADIWG::Mdtranslator::Readers::Iso191152::Iso191152.get_int_obj
   end
end
