...
class TestReaderIso191152Maintenance < TestReaderIso191152Parent
   @@nameSpace = ADIWG::Mdtranslator::Readers::Iso191152::Maintenance
   ...
   def test_maintenance_no_frequency
      xDoc = TestReaderIso191152Parent.get_xml('iso19115-2_no_frequency.xml')
      TestReaderIso191152Parent.set_xdoc(xDoc)
